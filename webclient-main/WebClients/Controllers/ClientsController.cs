...
namespace WebClients.Controllers
{
	public class ClientsController : Controller
	{
		...
		public async Task<IActionResult> Details(int? id)
		{
			...
			// if Client found search for addresses
			var addresses = _context.Addresses.Where(q => q.ClientID == id).ToList();
			// if Addresses are founded then return to view in the viewBagObject
			if (addresses != null)
			{
